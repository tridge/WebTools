(() => {
    ...
    class VideoPanel {
	constructor(opts = {}) {
	    this.host = opts.host || location.hostname || "157.245.83.174";
	...
	_playHLS() {
		...
		console.warn("Mixed content would be blocked; opening WebRTC viewer instead.");
	...
	host: localStorage.getItem("video.host") || location.hostname || "157.245.83.174",
